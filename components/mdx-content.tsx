...
export async function MdxContent({ source }: Props) {
  ...
  return (
    <div
      className="
        max-w-none text-[16px] leading-7 text-zinc-200
        [&_h2]:mt-14 [&_h2]:mb-5 [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:leading-tight [&_h2]:text-zinc-100
        [&_h3]:mt-10 [&_h3]:mb-4 [&_h3]:text-xl [&_h3]:font-medium [&_h3]:text-zinc-100
        ...
        [&_summary]:cursor-pointer [&_summary]:list-none [&_summary]:px-5 [&_summary]:py-4 [&_summary]:text-sm [&_summary]:font-medium [&_summary]:text-zinc-100
        [&_summary::-webkit-details-marker]:hidden
        [&_details[open]_summary]:border-b [&_details[open]_summary]:border-white/10
        [&_pre]:my-6 [&_pre]:overflow-x-auto [&_pre]:rounded-2xl [&_pre]:border [&_pre]:border-white/10 [&_pre]:bg-transparent [&_pre]:p-5
